...
lvim.builtin.which_key.mappings["p"] = { ":Telescope projects<cr>", "Find Projects" }
-- }}}
...
-- lvim.builtin.which_key.mappings["ii"] = { ":lua require('harpoon.ui').toggle_quick_menu()<cr>", "Harpoon" }
-- lvim.builtin.which_key.mappings["ia"] = { ":lua require('harpoon.mark').add_file()<cr>", "Harpoon Add" }
-- lvim.builtin.which_key.mappings["in"] = { ":lua require('harpoon.ui').nav_next()<cr>", "Harpoon Next" }
-- lvim.builtin.which_key.mappings["ip"] = { ":lua require('harpoon.ui').nav_prev()<cr>", "Harpoon Prev" }
-- lvim.builtin.which_key.mappings["it"] = { ":lua require('harpoon.tmux').gotoTerminal('{down-of}')<cr>",  "Harpoon Terminal" }
-- }}}
